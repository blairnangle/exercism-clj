(ns exercism-clj.annalyns-infiltration.annalyns-infiltration)
...
(defn can-spy?
  ...
  (not (every? false? [knight-awake? archer-awake? prisoner-awake?])))
...
(defn can-free-prisoner?
  ...
  (if dog-present? (not archer-awake?) (every? true? [prisoner-awake? (not knight-awake?) (not archer-awake?)])))
