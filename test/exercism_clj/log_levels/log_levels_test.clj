(ns exercism-clj.log-levels.log-levels-test
  (:require [clojure.test :refer [deftest is]]
            [exercism-clj.log-levels.log-levels :as log-levels]))
...
(deftest reformat-info-test
  (is (= "Disk fragmented (info)" (log-levels/reformat "[INFO]: Disk fragmented"))))
