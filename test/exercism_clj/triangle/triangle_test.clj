...
(deftest is-valid
  (is (true? (triangle/is-valid? 2 2 2))))

(deftest is-invalid-negative
  (is (false? (triangle/is-valid? 2 2 -1))))

(deftest is-invalid-proportions
  (is (false? (triangle/is-valid? 4 2 1))))
